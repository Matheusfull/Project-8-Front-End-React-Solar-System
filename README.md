...
<details>
  ...
  As imagens dos planetas e as informações das missões são fornecidas no projeto. Tive como meta desenvolver os componentes necessários para exibi-los na tela, conforme o descrito nos requisitos.
</details>
...
<details>
  ...
  - Use o comando: `git clone git@github.com:Matheusfull/Project-8-Front-End-React-Solar-System.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd Project-8-Front-End-React-Solar-System`
